...
if __name__ == '__main__':
    ...
    parser.add_argument('--cross_attn_window_encoder', type=int, default=16, help='cross attention window size for encoder')
    parser.add_argument('--cross_attn_window_decoder', type=int, default=16, help='cross attention window size for decoder')
    parser.add_argument('--local_attention_window_len', type=int, default=16, help='local attention window length')
    ...
    parser.add_argument('--patching_threshold', type=float, default=3, help='patching threshold')
    parser.add_argument('--patching_threshold_add', type=float, default=None, help='additional patching threshold')
